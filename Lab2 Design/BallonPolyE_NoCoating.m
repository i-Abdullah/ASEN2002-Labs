...
% TEH SUN:
AbsroptivitySun = 0.8; %unitless
qSun = 1370; % W / m^2 

% Albedo
qEarth = 237; % W / m^2
AbsroptivityEarth = 0.6; %unitless

% Emissivity of Ballon
EmissivityMaterial = 0.6; %unitless
...
clearvars -except HightNight_NoCoat HightDay_NoCoat HightNightMay HightDayMay
